...
func (c *ComentariosComunidadController) URLMapping() {
...
func (c *ComentariosComunidadController) Post() {
	var v models.ComentariosComunidad
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddComentariosComunidad(&v); err == nil {
...
func (c *ComentariosComunidadController) GetOne() {
	...
	v, err := models.GetComentariosComunidadById(id)
	if err != nil {
		logs.Error(err)
...
// GetAll ...
func (c *ComentariosComunidadController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllComentariosComunidad(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
func (c *ComentariosComunidadController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.ComentariosComunidad{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateComentariosComunidadById(&v); err == nil {
...
func (c *ComentariosComunidadController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteComentariosComunidad(id); err == nil {
