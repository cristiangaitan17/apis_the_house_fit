...
func (c *DietaComidasController) URLMapping() {
...
func (c *DietaComidasController) Post() {
	var v models.DietaComidas
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddDietaComidas(&v); err == nil {
...
func (c *DietaComidasController) GetOne() {
	...
	v, err := models.GetDietaComidasById(id)
	if err != nil {
		logs.Error(err)
...
// GetAll ...
func (c *DietaComidasController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllDietaComidas(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
func (c *DietaComidasController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.DietaComidas{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateDietaComidasById(&v); err == nil {
...
func (c *DietaComidasController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteDietaComidas(id); err == nil {
