...
func (t *ResenasGimnasio) TableName() string {
	return "resenas_gimnasio"
}

func init() {
	orm.RegisterModel(new(ResenasGimnasio))
}

// AddResenasGimnasio insert a new ResenasGimnasio into database and returns
// last inserted Id on success.
func AddResenasGimnasio(m *ResenasGimnasio) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}
...
// UpdateResenasGimnasio updates ResenasGimnasio by Id and returns error if
// the record to be updated doesn't exist
func UpdateResenasGimnasioById(m *ResenasGimnasio) (err error) {
	o := orm.NewOrm()
	v := ResenasGimnasio{Id: m.Id}
...
// DeleteResenasGimnasio deletes ResenasGimnasio by Id and returns error if
// the record to be deleted doesn't exist
func DeleteResenasGimnasio(id int) (err error) {
	o := orm.NewOrm()
	v := ResenasGimnasio{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&ResenasGimnasio{Id: id}); err == nil {
