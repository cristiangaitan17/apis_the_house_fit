...
// AddDietaComidas insert a new DietaComidas into database and returns
...
// GetDietaComidasById retrieves DietaComidas by Id. Returns error if Id doesn't exist
...
// GetAllDietaComidas retrieves all DietaComidas matches certain condition. Returns empty list if
// no records exist
...
// UpdateDietaComidas updates DietaComidas by Id and returns error if
...
// DeleteDietaComidas deletes DietaComidas by Id and returns error if
