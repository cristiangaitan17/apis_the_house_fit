...
func (c *NutricionController) URLMapping() {
...
func (c *NutricionController) Post() {
	var v models.Nutricion
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddNutricion(&v); err == nil {
...
func (c *NutricionController) GetOne() {
	...
	v, err := models.GetNutricionById(id)
	if err != nil {
		logs.Error(err)
...
// GetAll ...
func (c *NutricionController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllNutricion(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
func (c *NutricionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Nutricion{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateNutricionById(&v); err == nil {
...
func (c *NutricionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteNutricion(id); err == nil {
