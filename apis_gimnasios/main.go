...
func main() {
	...
	dbUser := os.Getenv("APIS_GIMNASIOS_PGUSER")
	dbPass := os.Getenv("APIS_GIMNASIOS_PGPASS")
	dbHost := os.Getenv("APIS_GIMNASIOS_PGHOST")
	dbPort := os.Getenv("APIS_GIMNASIOS_PGPORT")
