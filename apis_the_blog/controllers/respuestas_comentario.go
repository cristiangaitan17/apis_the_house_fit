...
func (c *RespuestasComentarioController) URLMapping() {
...
func (c *RespuestasComentarioController) Post() {
	var v models.RespuestasComentario
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddRespuestasComentario(&v); err == nil {
...
func (c *RespuestasComentarioController) GetOne() {
	...
	v, err := models.GetRespuestasComentarioById(id)
	if err != nil {
		logs.Error(err)
...
// GetAll ...
func (c *RespuestasComentarioController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllRespuestasComentario(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
func (c *RespuestasComentarioController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.RespuestasComentario{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateRespuestasComentarioById(&v); err == nil {
...
func (c *RespuestasComentarioController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteRespuestasComentario(id); err == nil {
