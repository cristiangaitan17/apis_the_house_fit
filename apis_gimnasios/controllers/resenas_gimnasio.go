...
type ResenasGimnasioController struct {
	beego.Controller
}

func (c *ResenasGimnasioController) URLMapping() {
...
// Post ...
func (c *ResenasGimnasioController) Post() {
	var v models.ResenasGimnasio
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddResenasGimnasio(&v); err == nil {
...
// GetOne ...
func (c *ResenasGimnasioController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetResenasGimnasioById(id)
	if err != nil {
		logs.Error(err)
...
// GetAll ...
func (c *ResenasGimnasioController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllResenasGimnasio(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
// Put ...
func (c *ResenasGimnasioController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.ResenasGimnasio{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateResenasGimnasioById(&v); err == nil {
...
// Delete ...
func (c *ResenasGimnasioController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteResenasGimnasio(id); err == nil {
