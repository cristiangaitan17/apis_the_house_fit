...
func (c *NoticiasController) URLMapping() {
...
func (c *NoticiasController) Post() {
	var v models.Noticias
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddNoticias(&v); err == nil {
...
// GetAll ...
func (c *NoticiasController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllNoticias(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
func (c *NoticiasController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Noticias{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateNoticiasById(&v); err == nil {
...
func (c *NoticiasController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteNoticias(id); err == nil {
