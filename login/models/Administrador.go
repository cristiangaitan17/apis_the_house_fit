...
type Administrador struct {
	Id                int       `orm:"column(id_administrador);pk;auto"`
	NombreGym         string    `orm:"column(nombre_gym);null"`
	Nit               string    `orm:"column(nit);null"`
	AnioFundacion     int       `orm:"column(anio_fundacion);null"`
	CantidadClientes  int       `orm:"column(cantidad_clientes);null"`
	...
	PropietarioNombre string    `orm:"column(propietario_nombre);null"`
	Telefono          string    `orm:"column(telefono);null"`
	Correo            string    `orm:"column(correo);null"`
	PaginaWeb         string    `orm:"column(pagina_web);null"`
	Firma             string    `orm:"column(firma);null"`
	FechaFirma        time.Time `orm:"column(fecha_firma);type(date);null"`
